...
function Article1({ title, author, date, content, authorImageUrl, authorBio }) {
  return (
	...
	<div className="w-full mx-auto space-y-4 text-center">
		...
		<p className="text-sm dark:text-gray-600">by &ensp;
			<a rel="noopener noreferrer" href="#" target="_blank" className="underline dark:text-blue-400">
	...
	<div className="pt-12 border-t dark:border-gray-300">
		...
		<div className="flex justify-center pt-4 space-x-4 align-center">
			<a rel="noopener noreferrer" href="#" aria-label="Dribble" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-blue-400">
			...
			<a rel="noopener noreferrer" href="#" aria-label="Twitter" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-blue-400">
				<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
			...
			<a rel="noopener noreferrer" href="#" aria-label="Email" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-blue-400">
				<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
